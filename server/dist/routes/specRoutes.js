 ...
 */
router.post("/create", authenticatejwt_1.authenticateJWT, specController_1.createSpec);
/**
 * @swagger
 * /specs/update:
 *   put:
 ...
 *         description: Internal server error
 */
router.put("/update", authenticatejwt_1.authenticateJWT, specController_1.updateSpec);
/**
 * @swagger
 * /specs/{specId}:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/:specId", authenticatejwt_1.authenticateJWT, specController_1.getSpecById);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/project/:projectId", authenticatejwt_1.authenticateJWT, specController_1.getAllSpecsByProjectId);
/**
 * @swagger
 * /specs/delete:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete("/delete", authenticatejwt_1.authenticateJWT, specController_1.deleteSpec);
