...
const PricingCard = ({ name, Price, description, index }: PricingCardProps) => {
  return (
    ...
    >
      ...
      <p className="mt-5 text-center text-secondary text-4xl font-bold">${Price}</p>
      ...
      <div className="w-full mx-auto flex items-center justify-center mt-5">
        <button className="mt-6 px-10 text-secondary py-2 border border-secondary hover:bg-black hover:text-white font-semibold rounded-lg">
          Get Started
        </button>
      </div>
    </div>
